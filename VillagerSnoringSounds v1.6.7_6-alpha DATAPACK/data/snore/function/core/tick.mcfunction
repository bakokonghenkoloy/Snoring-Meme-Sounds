...
execute as @e[type=minecraft:villager,nbt=!{IsBaby:1b},tag=is_snoring_v] at @s unless data entity @s SleepingX unless data entity @s Brain.memories."minecraft:sleeping_pos" run function snore:util/wake_villager
execute as @e[type=minecraft:villager,nbt={IsBaby:1b},tag=is_snoring_b] at @s unless data entity @s SleepingX unless data entity @s Brain.memories."minecraft:sleeping_pos" run function snore:util/wake_baby
